...
<span onclick="window.location = '../mecanica';" class="shadow-sm pt-5 left-row">&lt;&lt;</span>

<span onclick="window.location = '../informatica';" class="shadow-sm pt-5 right-row">&gt;&gt;</span>
...
<script>
  ...
  function SelectChanged(tag) {
    ...
    // var x = document.getElementById("mySelect").value;
		sessionStorage.setItem("cookie_electronica", tag); 
...
window.onload = function() {
  var storedValue = sessionStorage.getItem("cookie_electronica"); 
  if (storedValue !== null) {
  ...
  function loadXMLDoc(tag) {
    ...
    xmlhttp.open("GET", "ElectronicaXML_Main0.xml", true);
    xmlhttp.send();
  }
