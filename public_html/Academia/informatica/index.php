...
<span onclick="window.location = '../electronica';" class="shadow-sm pt-5 left-row">&lt;&lt;</span>

<span onclick="window.location = '../control';" class="shadow-sm pt-5 right-row">&gt;&gt;</span>
...
<script>
  ...
  function SelectChanged(tag) {
    ...
    // var x = document.getElementById("mySelect").value;
		sessionStorage.setItem("cookie_informatica", tag); 
...
window.onload = function() {
  var storedValue = sessionStorage.getItem("cookie_informatica"); 
  if (storedValue !== null) {
  ...
  function loadXMLDoc(tag) {
    ...
    xmlhttp.open("GET", "InformaticaXML_Main0.xml", true);
    xmlhttp.send();
  }
