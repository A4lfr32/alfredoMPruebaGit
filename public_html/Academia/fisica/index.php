...
<span onclick="window.location = '../matematicas';" class="shadow-sm pt-5 left-row">&lt;&lt;</span>

<span onclick="window.location = '../mecanica';" class="shadow-sm pt-5 right-row">&gt;&gt;</span>
...
<script>
  ...
  function SelectChanged(tag) {
    ...
    // var x = document.getElementById("mySelect").value;
		sessionStorage.setItem("cookie_fisica", tag); 
...
window.onload = function() {
  var storedValue = sessionStorage.getItem("cookie_fisica"); 
  if (storedValue !== null) {
  ...
  function loadXMLDoc(tag) {
    ...
    xmlhttp.open("GET", "FisicaXML_Main0.xml", true);
    xmlhttp.send();
  }
