...
<span onclick="window.location = '../AI';" class="shadow-sm pt-5 left-row">&lt;&lt;</span>

<span onclick="window.location = '../fisica';" class="shadow-sm pt-5 right-row">&gt;&gt;</span>
...
<script>
  ...
  function SelectChanged(tag) {
    ...
    // var x = document.getElementById("mySelect").value;
		sessionStorage.setItem("cookie_matematicas", tag); 
...
window.onload = function() {
  var storedValue = sessionStorage.getItem("cookie_matematicas"); 
  if (storedValue !== null) {
  ...
  function loadXMLDoc(tag) {
    ...
    xmlhttp.open("GET", "MatematicaXML_Main.xml", true);
    xmlhttp.send();
  }
