...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    ...
    <link rel="stylesheet" href="timeline7.css">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <p style="text-align: justify;"><b>Abstract:</b> There are some difficulties in streaming or recording activities, based on a solution given in
        ...
        knowledge when calibrating in a new workspace. The proposal is a self-calibration process,
        to facilitate this issue.</p>
        <p style="text-align: justify;">
        Robotic morphology is investigated then this type of device is classified, the main trademarks
        in the world market are found and some alternative applications of this same solution are
        mentioned.</p>
        <p style="text-align: justify;">
